...
public class ReviewActivity extends AppCompatActivity {
    ...
    private reviewsClass productModelGlobal;
    ...
    private void initView() {
        ...
        productModelGlobal = new Gson().fromJson(getIntent().getStringExtra(EXTRA_PRODUCT_MODEL), reviewsClass.class);
     ...
     * @param productModel
     */
    private void updateRating(ReviewModel reviewModel, reviewsClass productModel) {
        reviewsClass rate = new reviewsClass();
    ...
    private void setRatingByColor(reviewsClass productModel) {
        ...
        tvTotalPemberiBintang.setText(totalAllVoters + " total");
